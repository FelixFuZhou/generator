...
public class JaxbMapper {
    ...
    /**cData 需要文本的字段名  ^field 
     * Java Object->Xml without encoding.
     */
    public static String toXml(Object root, String[] cData){
        Class clazz = Reflections.getUserClass (root);
        try {
            ByteArrayOutputStream writer= new ByteArrayOutputStream();
            XMLSerializer serializer = getXMLSerializer(cData,writer);
            createMarshaller (clazz, null).marshal (root, serializer);
    ...
    private static XMLSerializer getXMLSerializer(String[] cData, OutputStream os) {
